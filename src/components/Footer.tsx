        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="col-span-1 sm:col-span-2 lg:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              <div className="w-12 h-12 sm:w-15 sm:h-15 bg-gradient-to-r from-consulting-blue to-consulting-light-blue rounded-lg flex items-center justify-center">
                                <img 
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/about" className="text-sm sm:text-base text-gray-300 hover:text-consulting-light-blue transition-colors">About Us</Link></li>
              <li><Link to="/services" className="text-sm sm:text-base text-gray-300 hover:text-consulting-light-blue transition-colors">Services</Link></li>
              <li><Link to="/industries" className="text-sm sm:text-base text-gray-300 hover:text-consulting-light-blue transition-colors">Industries</Link></li>
              <li><Link to="/testimonials" className="text-sm sm:text-base text-gray-300 hover:text-consulting-light-blue transition-colors">Testimonials</Link></li>
              <li><Link to="/contact" className="text-sm sm:text-base text-gray-300 hover:text-consulting-light-blue transition-colors">Contact</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-2">
                ...
                <span className="text-gray-300 text-xs sm:text-sm">+234 806 633 1176, +234 802 535 2020</span>
              </li>
              <li className="flex items-center space-x-2">
                <MapPin className="w-4 h-4 text-consulting-light-blue" />
                <span className="text-gray-300 text-xs sm:text-sm">19B, Kampala Street, Off Cairo Street, Ademola Adetokunbo Road, Wuse II, Abuja</span>
              </li>
            </ul>
          </div>
        </div>
