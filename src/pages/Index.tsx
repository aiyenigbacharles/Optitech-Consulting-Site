    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-100 via-gray-200 to-blue-100 overflow-hidden px-4">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-10 -right-10 sm:-top-20 sm:-right-20 md:-top-40 md:-right-40 w-20 h-20 sm:w-40 sm:h-40 md:w-80 md:h-80 bg-consulting-blue/10 rounded-full animate-float"></div>
          <div className="absolute -bottom-8 -left-8 sm:-bottom-16 sm:-left-16 md:-bottom-32 md:-left-32 w-16 h-16 sm:w-32 sm:h-32 md:w-64 md:h-64 bg-consulting-light-blue/10 rounded-full animate-float" style={{animationDelay: '1s'}}></div>
        </div>

        <div className="container mx-auto px-4 pt-20 sm:pt-16 md:pt-20 relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            <div className="text-center lg:text-left">
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 mb-4 sm:mb-6 animate-fade-in-up leading-tight">
                Excellence 
                <span className="text-consulting-blue"> and</span> Innovation
              </h1>
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 mb-6 sm:mb-8 max-w-2xl mx-auto lg:mx-0 animate-fade-in-up leading-relaxed" style={{ animationDelay: '0.2s' }}>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start animate-fade-in-up" style={{animationDelay: '0.4s'}}>
                <Button 
                  asChild
                  size="lg"
                  className="bg-consulting-blue hover:bg-consulting-light-blue text-white px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base lg:text-lg rounded-lg transition-all duration-300 hover:scale-105 shadow-lg w-full sm:w-auto"
                >
                  <Link to="/contact">
                    Get Started Today
                ...
                <Button 
                  ...
                  variant="outline"
                  size="lg"
                  className="border-consulting-blue text-consulting-blue hover:bg-consulting-blue hover:text-white px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base lg:text-lg rounded-lg transition-all duration-300 w-full sm:w-auto"
                >
              ...
              {/* Trust indicators */}
              <div className="mt-6 sm:mt-8 lg:mt-12 flex flex-col sm:flex-row flex-wrap items-center justify-center lg:justify-start gap-3 sm:gap-4 lg:gap-6 animate-fade-in-up" style={{animationDelay: '0.6s'}}>
                <div className="flex items-center space-x-2">
                  <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-green-500 flex-shrink-0" />
                  <span className="text-xs sm:text-sm text-gray-600">Trusted by several clients</span>
                </div>
                <div className="flex items-center space-x-2">
                  <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-green-500 flex-shrink-0" />
                  <span className="text-xs sm:text-sm text-gray-600">98% success rate</span>
                </div>
              </div>
            </div>

            <div className="relative animate-fade-in-up mt-8 lg:mt-0" style={{animationDelay: '0.8s'}}>
              <img 
                src="/Training.jpg"
      ...
      {/* Stats Section */}
      <section ref={statsRef} className="py-12 sm:py-16 bg-consulting-blue">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-4 md:gap-8">
      ...
      {/* CTA Section */}
      <section className="py-16 sm:py-20 bg-gradient-to-r from-consulting-blue to-consulting-light-blue">
